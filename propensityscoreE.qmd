...
-   Hint 1: You should consider all four steps in the propensity score (PS) analysis:
    ...
    -   Step 3: Balance checking using SMD. Consider SMD \<0.2 as a good covariate balancing. Remember, you need to multiply matching weights and survey weights to get survey-based estimates.
