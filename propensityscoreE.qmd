## Exercise (PS) {.unnumbered}

::: callout-tip
You can download all of the related files in a zip file **propensityscoreEx.zip** from [Github](https://github.com/ehsanx/EpiMethods/tree/main/LabExercises/)
