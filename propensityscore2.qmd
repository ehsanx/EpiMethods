...
Look at the documentation for arguments of `matchit` [@Matchit] (see also `?matchit`). In the current MatchIt (v4.x) API the main signature is:

```{r  step1b, eval=FALSE}
matchit(formula, data, method = "nearest", distance = "glm",
