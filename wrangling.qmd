...
::: {.callout-note}
This chapter focuses on "Data Wrangling." The following structure will be consistently applied across all chapters:

- A concise **overview** of the chapter's tutorials on a single page (see below)
- Compilation of all **tutorial topics** (multiple pages)
- Summary of **R functions** utilized in the chapter
- Chapter-specific **quiz** (self-learning; optional)
- Practice **exercises** for the chapter
:::
