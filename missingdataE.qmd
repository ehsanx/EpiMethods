...
::: callout-tip
You can download all of the related files in a zip file **missingdataEx.zip** from [Github](https://github.com/ehsanx/EpiMethods/tree/main/LabExercises/)
