...
data <- data.frame(
  Function_name = c("as.factor", "cbind", "CreateTableOne", "data.frame", "dim", "filter", "function", "head", "is.na", "levels", "list", "mode", "na.omit", "names", "nlevels", "nrow", "plot", "print", "prop.table", "rbind", "read.csv", "relevel", "read_xpt", "save", "select", "set.seed", "str", "subset", "summary", "table", "write.csv"),
  Package_name = c("base", "base", "tableone", "base", "base", "dplyr", "base", "base", "base", "base", "base", "base", "base/stats", "base", "base", "base", "base/graphics", "base", "base", "base", "base/utils", "base/stats", "haven", "base", "dplyr", "base", "base/utils", "base, dplyr", "base", "base", "base/utils"),
  Use = c(
  ...
  "Reads data from a SAS transport (.xpt) file; returns variable names in their original uppercase form.",
