## Functions for wrangling {.unnumbered}
...
4. **Tutorials and Online Courses**: Platforms like DataCamp, Coursera, and edX offer R courses that cover many functions in depth. Also there are examples of dedicated R tutorial websites that you might find useful. One example is ["Introduction to R for health data analysis"](https://ehsanx.github.io/intro2R/) by Ehsan Karim, An Hoang and Qu.

5. **Books**: There are numerous R programming books, such as ["R for Data Science"](https://r4ds.had.co.nz/) by Hadley Wickham and ["The Art of R Programming"](https://nostarch.com/artofr.htm) by Norman Matloff.

6. **Workshops and Webinars**: Institutions and organizations occasionally offer R programming workshops or webinars.
