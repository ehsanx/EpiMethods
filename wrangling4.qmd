...
The `read_xpt` function retrieves the SAS transport (`.xpt`) dataset. Note that `read_xpt` returns variable names in their original uppercase form (e.g., `RIAGENDR`). The following lines, just like before, help understand its structure.
