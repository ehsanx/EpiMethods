...
You could watch the videos describing [R basics](https://youtu.be/wMwH7iroGIo), [R for loops and functions](https://youtu.be/A5TTDqhvBrM), and [manipulating real datasets using R](https://youtu.be/3Hn1QsQHo-w).
