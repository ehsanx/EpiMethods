...
The datasets used in this tutorial (`BtheB` and `respiratory`) are built into the [`HSAUR2`](https://cran.r-project.org/package=HSAUR2) R package and are loaded directly from there (e.g., `data("BtheB", package = "HSAUR2")`); no separate data download is required.
:::
