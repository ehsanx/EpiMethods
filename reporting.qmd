...
This is a tools-focused tutorial; it does not load analytic datasets. Supporting example files (e.g., a reference `.bib` file and a template) can be accessed from [this GitHub repository folder](https://github.com/ehsanx/EpiMethods/tree/main/Data/reporting)
