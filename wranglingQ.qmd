...
```{=html}
<iframe src="wranglingQi.html" width="100%" height="600" frameborder="0">
...
1.  **Downloading the File:**
    -   Navigate to the link: [See here](Quiz/QuizWrangling.Rmd). If not downloading immediately, right-click on the link and select "Save link as..." from the dropdown menu.
    -   Alternatively <a href="Quiz/QuizWrangling.Rmd" download>click here</a> for downloading the quizzes.
