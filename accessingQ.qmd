## Quiz on accessing {.unnumbered}

1.  **Downloading the File:**
    -   Navigate to the link: [See here](Quiz/QuizAccessing.Rmd).
    -   Right-click on the link and select "Save link as..." from the dropdown menu.
    -   Alternatively <a href="Quiz/QuizAccessing.Rmd" download>click here</a> for downloading the quizzes on data wrangling.
