...
library(flextable)
Variables <- rownames(coef(summary(fit.glm)))
dd <- round(as.data.frame(coef(summary(fit.glm))),2)
...
```{r, caption="Your Table Title", warning=FALSE, message=FALSE, cache=TRUE, echo=FALSE}
library(flextable)
Variables <- rownames(coef(summary(fit.psm)))
dd <- round(as.data.frame(coef(summary(fit.psm))),2)
coefficients_df <- cbind(Variables, dd)
ft <- flextable(data = coefficients_df)
ft
```
...
```{r, caption="Your Table Title", warning=FALSE, message=FALSE, cache=TRUE, echo=FALSE}
library(flextable)
Variables <- rownames(coef(summary(fit.ipw)))
dd <- round(as.data.frame(coef(summary(fit.ipw))),2)
coefficients_df <- cbind(Variables, dd)
ft <- flextable(data = coefficients_df)
ft
```
...
```{r, caption="Your Table Title", warning=FALSE, message=FALSE, cache=TRUE, echo=FALSE}
library(flextable)
Variables <- rownames(coef(summary(fit.psm.sl)))
dd <- round(as.data.frame(coef(summary(fit.psm.sl))),2)
coefficients_df <- cbind(Variables, dd)
ft <- flextable(data = coefficients_df)
ft
```
...
```{r, caption="Your Table Title", warning=FALSE, message=FALSE, cache=TRUE, echo=FALSE}
library(flextable)
Variables <- rownames(coef(summary(fit.ipw.sl)))
dd <- round(as.data.frame(coef(summary(fit.ipw.sl))),2)
coefficients_df <- cbind(Variables, dd)
ft <- flextable(data = coefficients_df)
ft
```
