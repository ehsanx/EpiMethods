...
::: callout-note
R Markdown (`.Rmd`) and Quarto (`.qmd`) are closely related authoring formats: Quarto is the newer, language-agnostic successor and uses nearly identical syntax. This book itself is written in Quarto, while this tutorial introduces R Markdown.
:::
