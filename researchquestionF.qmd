...
data <- data.frame(
  Function_name = c("as.data.frame", "as.formula", "confint", "degf", "describe", "exp", "glm", "lapply", "length", "plot_missing", 
                    "publish", "Reduce", "round", "saveRDS", "skim", "svydesign", "svyglm", "unique", "weights"),
  Package_name = c("base", "base/stats", "base/stats", "survey", "DescTools", "base", "base/stats", "base", "base", "DataExplorer",
