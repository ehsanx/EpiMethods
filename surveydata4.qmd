...
Note that we have 0 effect modifiers and 2 interactions. Here a statistical *interaction* simply means that the effect of one variable on the outcome depends on the level of another (a product term improves model fit), whereas *effect modification* is the causal counterpart, where the causal effect of the exposure differs across strata of a third variable. See the [confounding module](confounding.html) for the distinction between interaction and effect modification.
