...
A .txt data file can be imported using the `read.table` function. As an example, consider you have a [dataset named grade](https://github.com/ehsanx/EpiMethods/blob/main/Data/wrangling/grade.txt) in the specified path.
...
<iframe src="https://www.youtube.com/embed/3Hn1QsQHo-w" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border:0;" allowfullscreen>
