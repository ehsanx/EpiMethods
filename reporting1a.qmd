...
2.  Install required packages:
    ...
    > Optional: the `devtools` package (`install.packages("devtools")`) is only needed if you plan to do R package development. It is heavier and requires build tools (compilers), so it is not required for the Git setup steps here.
