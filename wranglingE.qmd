## Exercise on wrangling {.unnumbered}

::: callout-tip
You can download all of the related files in a zip file from [Github](https://github.com/ehsanx/EpiMethods/tree/main/LabExercises/wranglingEx.zip)
:::
