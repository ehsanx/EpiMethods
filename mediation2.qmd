...
(The subscript $\theta_2$ is intentionally skipped here; it is reserved for the counterfactual exposure term $a^*$ that appears later in the mediation decomposition, so the notation lines up with the Step-4 outcome model.)
