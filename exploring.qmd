...
The tutorials in this chapter reuse the RHC analytic dataset (`rhcAnalyticTest.RDS`), which can be accessed from [this GitHub repository folder](https://github.com/ehsanx/EpiMethods/tree/main/Data/machinelearningCausal). This dataset originates from the machine learning with causal inference module, and is reused here to demonstrate exploratory data analysis methods.
:::
