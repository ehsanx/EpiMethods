...
This tutorial focuses on the role of mediator variables in estimating treatment effects. It assesses how adjusting for the mediator influences the estimated treatment effect, exploring both scenarios where the true treatment effect is either non-null or null. The formal decomposition of an effect into direct and indirect components is developed in detail later in the dedicated [Mediation analysis chapter](mediation.html).
...
### [Simpson's Paradox](confounding3b.html)
