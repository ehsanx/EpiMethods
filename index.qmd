...
table_content <- gsub("Grasping Confounding", "<a href='confounding.html'>Role (R) of Variables</a>", table_content)
table_content <- gsub("Adjustment Techniques", "<a href='predictivefactors.html'>Predictive (P) Modelling</a>", table_content)
...
table_content <- gsub("Reporting Guideline", "<a href='reporting.html'>Reporting Guideline (G)</a>", table_content)
table_content <- gsub("Machine Learning", "<a href='machinelearning.html'>Machine (M) Learning</a>", table_content)
