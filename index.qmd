...
Embark on a journey through 14 core learning modules, that includes one introductory module about R. Letters in the parentheses (W, A, Q, R, P, D, M, S, L, C, N, T, I, G) are the chapter indicators; these are indicated along with quizzes, R functions, and exercises associated with the corresponding chapters. Only key chapters have exercises.
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
author <- "Karim, M. E., and Hossain, M. B. and Frank, H.A. others"
