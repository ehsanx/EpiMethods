...
::: callout-note
The AUC and Brier score below are computed on the same data used to fit the model (no `newdata`, no split or cross-validation). They are therefore *apparent* (optimistic) performance estimates. The cross-validation and data-splitting approaches shown later in this module, and the optimism correction in [predictivefactors7](predictivefactors7.html), give less biased estimates of out-of-sample performance.
:::
