...
new_data_3 <- data.frame(
  Function_name = c("cox.zph", "coxph", "ggforest", "glm.nb", "multinom", "polr", "Surv", "survdiff",
                    "survfit", "svy_vglm", "svycoxph", "svyglm.nb", "svykm", "svyolr"),
  Package_name = c("survival", "survival", "survminer", "MASS", "nnet", "MASS", "survival", "survival",
  ...
  Use = c("To assess the proportional hazard assumption", "To fit cox regression model",
          ...
          "To fit a negative binomial model (estimates the dispersion parameter theta)",
